  ...
  return (
    <div id="app">
      ...
      <section id="home" className="hero">
        <div className="hero-bg" style={{backgroundImage: "url('/assets/DSC02739.jpg')"}}></div>
      ...
      <section className="parallax-section">
        <div className="parallax-bg" style={{backgroundImage: "url('/assets/hero/hero-1.jpeg')"}}></div>
      </section>
