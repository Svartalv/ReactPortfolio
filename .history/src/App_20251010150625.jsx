...
import { FaSpotify, FaSoundcloud, FaInstagram, FaBars, FaTimes } from 'react-icons/fa'
    ...
    <div id="app">
      ...
      <section id="home" className="hero">
        ...
        <div className="social-icons">
          <a href="https://open.spotify.com/artist/2DHGsoZWpcTUcY8x6tct8n" target="_blank" rel="noreferrer" title="Spotify"><FaSpotify size={36} /></a>
          <a href="https://soundcloud.com/pamela-svart" target="_blank" rel="noreferrer" title="SoundCloud"><FaSoundcloud size={36} /></a>
          <a href="https://www.instagram.com/pamelasvart/" target="_blank" rel="noreferrer" title="Instagram"><FaInstagram size={36} /></a>
          <a href="https://ra.co/dj/pamelasvart" target="_blank" rel="noreferrer" title="Resident Advisor" style={{fontSize:18,letterSpacing:".18em"}}>RA</a>
        </div>
      </section>
      ...
      <section className="parallax-section">
        <div className="parallax-bg" style={{backgroundImage: "url('/assets/runes.jpg')"}}></div>
      </section>
